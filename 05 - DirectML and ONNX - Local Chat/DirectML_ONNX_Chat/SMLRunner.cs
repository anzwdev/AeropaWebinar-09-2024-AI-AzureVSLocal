...
namespace DirectML_ONNX_Chat
{
    public class SLMRunner : IDisposable
    {
        private readonly string ModelDir =
            //"D:\\Conferences\\2024-09 - Local AI\\00 - Models\\onnx-models\\phi3-directml-int4-awq-block-128";
            "D:\\Conferences\\2024-09 - Local AI\\00 - Models\\onnx-models\\Meta-Llama-3.1-8B-Instruct-ONNX-DirectML-GenAI-INT4";
        ...
        public async IAsyncEnumerable<string> InferStreamingAsync(string prompt, [EnumeratorCancellation] CancellationToken ct = default)
        {
            ...
            generatorParams.SetSearchOption("max_length", 2024);
