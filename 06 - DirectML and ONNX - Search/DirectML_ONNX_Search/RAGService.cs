...
namespace DirectML_ONNX_Search
{
    public class RAGService : IDisposable
    {
        ...
        private readonly string modelDir =
            //Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "onnx-models", "all-MiniLM-L6-v2");
            "D:\\Conferences\\2024-09 - Local AI\\00 - Models\\onnx-models\\all-MiniLM-L6-v2";
        ...
        public async Task<List<TextChunk>> Search(string searchTerm, int top = 5)
        {
            ...
            return contents.DistinctBy(c => c.FilePath).ToList();
        }
